...
<!--
        ...
        == Igual
        === operador idêntico - Verifica se os valores são iguais e se são do mesmo tipo
        != ou <> operador diferente
        !== não idêntico
        < verifica se o valor da esquerda é menor q o da direita
        > verifica se o valor da direita é maior q o da esquerda
...
<!--
   ...
   XOR: -> retorna verdadeiro se uma das expressões for verdadeira e a outra falsa, ou vise-versa
            (Se as duas forem verdadeiras e duas forem falsas o resultado será falso.
            Ele espera obrigatoriamente que das expressões conectadas por ele uma seja verdadeira e a outra falsa.
            Se uma das expressões for verdadeira e a outra falsa não importando a posição do operador ai, sim, ele retorna verdadeiro.)

  ! -> Operador de negação inverte o resultado retornando pela express
-->
